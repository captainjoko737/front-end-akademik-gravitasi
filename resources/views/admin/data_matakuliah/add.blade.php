            ...
            <div class="col-lg-6">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.matakuliah.create') }}" method="POST" class="form-material">
                            {{ csrf_field() }}
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-line" placeholder="Masukan SKS" name="sks" id="sks" value="" required> 
                                </div>
