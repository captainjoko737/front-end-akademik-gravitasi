            ...
            <div class="col-lg-6">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.program_studi.create') }}" method="POST" class="form-material">
                            {{ csrf_field() }}
                            <div class="form-body">
                                ...
                                <a type="button" href="{{ route('admin.program_studi.index') }}" class="btn btn-inverse">Cancel</a>
                                <hr>
