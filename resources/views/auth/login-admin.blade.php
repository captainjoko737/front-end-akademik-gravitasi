    ...
    <div class="login-register" style="background-image:url({{ url('/public/assets/images/background/background.jpg') }});">
        <div class="login-box card rounded">
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" id="loginform" method="POST" action="{{ route('admin') }}">
                    {{ csrf_field() }}

                    <img class="center" src="{{ asset('/public/assets/images/restricted.png') }}" width="80vw">
                    <!-- <h3 class="box-title m-b-20 text-center font-weight-bold">Sistem Informasi Akademik</h3> -->
                    
                    <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                        <div class="col-xs-12">
                            <input class="form-control" id="username" type="text" class="form-control" name="username" placeholder="Username"> 
                    ...
                    <div class="form-group text-center">
                        <div class="col-xs-12 p-b-20">
                            <button class="btn btn-block btn-outline-danger btn-rounded" type="submit">Log In</button>
                        </div>
                    </div>
