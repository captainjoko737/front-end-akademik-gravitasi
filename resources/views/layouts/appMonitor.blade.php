...
<head>
    ...
    <!-- page css -->
    <link href="{{ asset('/public/css/pages/dashboard1.css') }}" rel="stylesheet">
    <!-- Custom CSS -->
    ...
    <link href="{{ asset('/public/css/pages/dashboard3.css') }}" rel="stylesheet" />
...
<body class="">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">AKADEMIK KEBIDANAN</p>
        </div>
    </div>
